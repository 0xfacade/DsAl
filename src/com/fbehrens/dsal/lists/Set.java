...
/**
 * A set is like a {@link Map} without data, i.e. it is a collection of elements
 * without duplicates. (Where {@link Object#equals(Object)} is used to compare
 * elements).
 * 
 * Internally, the keys of a Map are used to store the elements of the set. Note
 * that it depends on the Map whether null is supported as element.
 * 
 * @author Rossmanith
 *
 * @param <K>
...
public class Set<K> {
	...
	/**
	 * Creates a new empty set. (Here a {@link Hashtable} is used to store the
	 * elements)
	 */
	public Set() {
	...
	/**
	 * Creates a set where the elements are the keys of the given map. Note that
	 * changes to this set will have impact on the map m and vice versa!
	 * 
	 * @param m
	 *            The map which defines this set.
	 */
	public Set(Map<K, ?> m) {
		h = m;
	}
