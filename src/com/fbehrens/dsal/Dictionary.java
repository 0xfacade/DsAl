 ...
 * required for the {@link Map}-interface. Only
 * {@link Map#insert(Object, Object)}, {@link Map#delete(Object)}, and
 * {@link Map#iterator()} have to be implemented for subclasses of Dictionary,
 * however, other methods may also be implemented to improve efficiency.
 * 
 * @author Rossmanith
 *
 * @param <K>
...
public abstract class Dictionary<K, D> implements Map<K, D> {
	...
	/**
	 * Constant time implementation of {@link Map#isempty()} provided that
	 * creation of an {@link Iterator} with {@link #iterator()} costs only
	 * constant time.
	 */
